...
export default function FontSize(
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "h-7 flex items-center justify-between gap-0.5 text-xs border border-zinc-200 dark:border-zinc-700 rounded-sm bg-white dark:bg-zinc-800 px-2 focus:outline-none w-full text-zinc-800 dark:text-zinc-200",
          className
        )}
        title={title}
      >
        ...
        <input
          className="min-w-4 focus:outline-0"
          type="text"
