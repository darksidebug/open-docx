      ...
      <div className='flex items-center gap-x-1'>
        ...
        <div className="relative top-0.5 group">
          ...
          {editor?.isActive('table') && (
            <div className="absolute -left-2 top-5.5 p-0.5 text-[12px] hidden group-hover:flex flex-col bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded shadow-lg z-20 min-w-35 overflow-hidden">
              <button
                type="button"
                onClick={() => {
        ...
        <button
          ...
          className={`relative top-px p-1 rounded hover:bg-zinc-200 dark:hover:bg-zinc-800 cursor-pointer ${editor?.isActive('columnBlock') ? 'bg-zinc-200 dark:bg-zinc-700 text-blue-600 dark:text-blue-400' : ''}`}
        ...
        <div className='relative top-0.5 group'>
          <button className="p-1 rounded hover:bg-zinc-200 dark:hover:bg-zinc-800 cursor-pointer" title="Cell Background">
            <PaintBucket className='size-3.5' />
          </button>
          <div className='hidden group-hover:block absolute top-6 z-10 py-2.5 px-3 rounded-lg shadow-lg border border-gray-200 bg-white text-[13px] -translate-x-1/2'>
        ...
        <div className='relative top-px group'>
          ...
          <div className='hidden group-hover:block absolute top-6.5 z-10 py-2.5 px-3 rounded-lg shadow-lg border border-gray-200 bg-white text-[13px] -translate-x-1/2'>
            <div className='flex flex-col gap-y-0.75 p-1'>
              {colorSet.map((colors, index) => (
                <div
                  key={index}
        ...
        <button
          ...
          className="relative -top-px p-1 hover:bg-red-500 dark:hover:bg-red-500 rounded text-red-400 hover:text-white dark:text-zinc-300 disabled:opacity-40 cursor-pointer"
          title="Remove Table"
        >
