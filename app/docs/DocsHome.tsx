...
export default function DocsHome({ documents, templates, loadError }: DocsHomeProps) {
  ...
  return (
    <div className="min-h-full bg-[#F9FBFD] px-8 py-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-4">
          <button
            ...
            disabled={creating}
            className="w-36 shrink-0 rounded border border-gray-300 bg-white text-left hover:shadow-md disabled:opacity-50"
          >
            <div className="flex aspect-3/4 items-center justify-center bg-white">
              <Plus className="size-10 text-blue-500" />
            </div>
            <div className="border-t border-gray-200 px-2 py-1.5 text-xs text-gray-700">Blank document</div>
          </button>
